...
(function () {
  ...
  var D = function (a) {
    ...
    if (!B) for (B = {}, b = 0; 65 > b; b++) B[b] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b);
  ...
  var E = new firebase.INTERNAL.ErrorFactory("messaging", "Messaging", q),
    ...
    return fetch("https://fcm.googleapis.com/fcm/connect/subscribe", {
      ...
      if (a.error) throw E.create(l.P, {
        message: a.error.message
      });
      if (!a.token) throw E.create(l.S);
      if (!a.pushSet) throw E.create(l.R);
      return {
        token: a.token,
        pushSet: a.pushSet
      };
    ...
    return G(a).then(function (a) {
      return new Promise(function (b, c) {
        var d = a.transaction(["fcm_token_object_Store"], "readwrite").objectStore("fcm_token_object_Store").put(m);
  ...
  F.prototype.X = function (a, b) {
    return b instanceof ServiceWorkerRegistration ? "string" !== typeof a || 0 === a.length ? Promise.reject(E.create(l.g)) : J(this, a).then(function (c) {
      ...
      if (a) return b.pushManager.getSubscription().catch(function () {
        ...
        var c;
        if (c = b) c = b.endpoint === a.endpoint && D(b.getKey("auth")) === a.auth && D(b.getKey("p256dh")) === a.p256dh;
  ...
  var M = function (a) {
    ...
    if (!a.options.messagingSenderId || "string" !== typeof a.options.messagingSenderId) throw this.a.create(l.g);
  ...
  var O = function (a, b) {
    ...
    var d = T().then(function (b) {
      if (b) {
        ...
        if (b) return N.registration.showNotification(b.title || "", b);
        if (a.b) return a.b(c);
      }
    });
    b.waitUntil(d);
  ...
  S.prototype.setBackgroundMessageHandler = function (a) {
    if (a && "function" !== typeof a) throw this.a.create(l.s);
    this.b = a;
  };
  ...
  Y.prototype.useServiceWorker = function (a) {
    if (!(a instanceof ServiceWorkerRegistration)) throw this.a.create(l.h);
    if ("undefined" !== typeof this.b) throw this.a.create(l.V);
    this.b = a;
  };
    ...
    return new Promise(function (d, f) {
      if (c) {
        if ("activated" === c.state) d(b);else if ("redundant" === c.state) f(a.a.create(l.l));else {
          var p = function () {
            if ("activated" === c.state) d(b);else if ("redundant" === c.state) f(a.a.create(l.l));else return;
  ...
  Y.prototype.i = function () {
    var a = this;
    if (this.b) return Z(this, this.b);
    this.b = null;
  ...
  var X = function (a) {
    "serviceWorker" in navigator && navigator.serviceWorker.addEventListener("message", function (b) {
      if (b.data && b.data[t.m]) switch (b = b.data, b[t.m]) {
        case u.N:
        case u.H:
          a.Y.next(b[t.u]);
      }
