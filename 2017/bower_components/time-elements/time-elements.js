(function () {
  'use strict'; // Shout out to https://github.com/basecamp/local_time/blob/master/app/assets/javascripts/local_time.js.coffee
  ...
  var dayFirst = null; // Private: Determine if the year should be separated from the month and day
  ...
  var yearSeparator = null; // Private: Determine if the date occurs in the same year as today's date.
  //
  ...
  var ExtendedTimePrototype = Object.create(window.HTMLElement.prototype); // Internal: Refresh the time element's formatted date when an attribute changes.
  //
  // Returns nothing.
